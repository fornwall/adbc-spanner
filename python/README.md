...
published for Linux (x86-64 glibc + x86-64 musl for Alpine, aarch64), macOS (arm64, x86-64), and
Windows (x86-64, arm64) — see [Supported platforms](#supported-platforms) for the minimum OS / libc
each one requires.
